...
# Define Kernel
kernel = GPy.kern.RBF(input_dim=len(bounds), variance=1.0, lengthscale=0.5, ARD=True)
...
# opt = safeopt.SafeOpt(gp, parameter_set, safe_threshold)
...
objective_function_name = obj_fun.MICHALEWICZ_FUNCTION_NAME
