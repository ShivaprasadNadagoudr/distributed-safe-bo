...
kernel = GPy.kern.Matern32(input_dim=len(bounds), variance=0.5, ARD=True)
...
# opt = safeopt.SafeOptSwarm(gp, safe_threshold, bounds=bounds, threshold=0)
opt = safeopt.SafeOpt(gp, parameter_set, safe_threshold, lipschitz=None, threshold=0.2)
...
objective_function_name = obj_fun.LANGERMANN_FUNCTION_NAME
